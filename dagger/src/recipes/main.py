...
class Recipes:
    @function
    def create_container(self, chef_version: str = "v0.10.0") -> dagger.Container:
        """Returns a container that echoes whatever string argument is provided"""

        chef_url = f"https://github.com/Zheoni/cooklang-chef/releases/download/{chef_version}/chef-x86_64-unknown-linux-musl.tar.gz"
